...
<?php foreach ($x as $key => $v):	?>
	<div class="col-md-4" style="text-align:center;margin-bottom:20px">
		<figure class="uk-overlay uk-overlay-hover thumbnail">
				<a href="#" class="res" data-toggle="modal" data-param="<?php echo $v['filename'] ?>" data-param1='<?php echo $v['descr'] ?>'><img src="<?php echo "../assets/images/transpo/".$v['filename'] ?> ?>" class="touris-image" style="padding:0;width:100%; height:200px;"/></a>
